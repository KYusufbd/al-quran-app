...
const DrawerRight = () => {
  ...
  const getPreselected = () => {
    ...
    if (authors && drawer.checked) {
      for (let i = 1; i < 16; i++) {
        ...
        authors.includes(i.toString()) ? (checkbox.checked = true) : (checkbox.checked = false);
      }
    }

    if (scriptNo && drawer.checked) {
      document.getElementById(`scr_${scriptNo}`).setAttribute('selected', 'selected');
    }
  };
  ...
  return (
    <div className="drawer drawer-end">
      <input id="my-drawer-4" type="checkbox" className="drawer-toggle" onChange={updateSelections} />
      ...
      <div className="drawer-side">
        ...
        <ul className="menu bg-base-200 text-base-content min-h-full w-70 p-4 flex flex-col gap-4">
          ...
          <details>
            ...
            <form id="script" onChange={selectScript} className="flex flex-col gap-1">
          ...
          <details>
            ...
            <form id="translations" onChange={selectAuths} className="flex flex-col gap-1">
              <div className="flex flex-row gap-2 py-2">
                <input type="checkbox" id="1" name="auth" value={1} className="w-6" />
                <label className="text-lg">আহসানুল বায়ান</label>
              </div>
              <div className="flex flex-row gap-2 py-2">
                <input type="checkbox" className="w-6" id="2" name="auth" value={2} />
                <label className="text-lg">ফজলুর রহমান</label>
              </div>
              <div className="flex flex-row gap-2 py-2">
                <input type="checkbox" className="w-6" id="3" name="auth" value={3} />
                <label className="text-lg">মুহিউদ্দীন খান</label>
              </div>
              <div className="flex flex-row gap-2 py-2">
                <input type="checkbox" className="w-6" id="4" name="auth" value={4} />
                <label className="text-lg">মুজিবুর রহমান</label>
              </div>
              <div className="flex flex-row gap-2 py-2">
                <input type="checkbox" className="w-6" id="5" name="auth" value={5} />
                <label className="text-lg">তাইসীরুল কুরআন</label>
              </div>
              <div className="flex flex-row gap-2 py-2">
                <input type="checkbox" className="w-6" id="6" name="auth" value={6} />
                <label className="text-lg">আবু বকর মুহাম্মাদ যাকারিয়া</label>
              </div>
              <div className="flex flex-row gap-2 py-2">
                <input type="checkbox" className="w-6" id="7" name="auth" value={7} />
                <label className="text-lg">The Clear Quran</label>
              </div>
              <div className="flex flex-row gap-2 py-2">
                <input type="checkbox" className="w-6" id="8" name="auth" value={8} />
                <label className="text-lg">Abdul Haleem</label>
              </div>
              <div className="flex flex-row gap-2 py-2">
                <input type="checkbox" className="w-6" id="9" name="auth" value={9} />
                <label className="text-lg">Jalalayn</label>
              </div>
              <div className="flex flex-row gap-2 py-2">
                <input type="checkbox" className="w-6" id="10" name="auth" value={10} />
                <label className="text-lg">Khan And Hilali</label>
              </div>
              <div className="flex flex-row gap-2 py-2">
                <input type="checkbox" className="w-6" id="11" name="auth" value={11} />
                <label className="text-lg">Taqi Usmani</label>
              </div>
              <div className="flex flex-row gap-2 py-2">
                <input type="checkbox" className="w-6" id="12" name="auth" value={12} />
                <label className="text-lg">Muhammad Marmaduke Pickthall</label>
              </div>
              <div className="flex flex-row gap-2 py-2">
                <input type="checkbox" className="w-6" id="13" name="auth" value={13} />
                <label className="text-lg">Saheeh International</label>
              </div>
              <div className="flex flex-row gap-2 py-2">
                <input type="checkbox" className="w-6" id="14" name="auth" value={14} />
                <label className="text-lg">Transliteration</label>
              </div>
              <div className="flex flex-row gap-2 py-2">
                <input type="checkbox" className="w-6" id="15" name="auth" value={15} />
