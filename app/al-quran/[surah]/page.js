          ...
          <div className="flex flex-col gap-2">
            {verses.map((verse, index) => {
              ...
              return (
                <div
                  id={ayah_no}
                  className="flex flex-col gap-3 shadow-2xl rounded-xl p-3 pt-4 bg-primary-content/75"
                  key={index}
                >
                  <p className="text-accent text-center font-bold -mb-3 mx-auto -mt-4">
                    {ayah_no}
                  </p>
                  <p className="text-3xl text-primary font-hafs leading-14 p-1 w-full rounded-xl bg-primary/10">
                    {verse.indo_pak}
                  </p>
